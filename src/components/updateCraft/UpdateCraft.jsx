...
const UpdateCraft = () => {
    ...
    const handleUpdateCraft = (e) => {
        ...
        // Construct updated craft object
        const updatedCraft = {
            image,
            itemName,
            subcategoryName,
        ...
        fetch(`https://artful-glass-and-paper-server.vercel.app/addCrafts/${loadedCraft._id}`, {
            method: 'PUT',
            headers: {
    ...
    return(
      ...
      <div className="w-full max-w-md lg:max-w-[60%] p-6 bg-white rounded-md shadow-md m-5">
        ...
        <form onSubmit={handleUpdateCraft} method="POST">
          <div className="grid grid-cols-2  gap-4 mb-4">
              <div>
                <label htmlFor="image" className="block text-sm font-medium text-gray-700">Image URL</label>
                <input type="text" id="image" name="image" defaultValue={loadedCraft.image} placeholder="Image URL" className={`input input-bordered w-full mt-2 ${formErrors.image ? 'input-error' : ''}`} />
              ...
              <div>
                ...
                <input type="text" defaultValue={loadedCraft.itemName} id="item_name" name="item_name" placeholder="Item Name" className={`input input-bordered w-full mt-2 ${formErrors.itemName ? 'input-error' : ''}`} />
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <textarea type="text" defaultValue={loadedCraft.shortDescription} id="short_description" name="short_description" placeholder="Description" className={`input input-bordered w-full mt-2 ${formErrors.shortDescription ? 'input-error' : ''}`} />
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" defaultValue={loadedCraft.price}  id="price" name="price" placeholder="Price" className={`input input-bordered w-full mt-2 ${formErrors.price ? 'input-error' : ''}`} />
                    {formErrors.price && <p className="text-red-500 text-sm mt-1">{formErrors.price}</p>}
                </div>
                <div>
                    <label htmlFor="rating" className="block text-sm font-medium text-gray-700">Rating</label>
                    <input type="text" defaultValue={loadedCraft.rating}  id="rating" name="rating" placeholder="Rating" className={`input input-bordered w-full mt-2 ${formErrors.rating ? 'input-error' : ''}`} />
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <select id="customization" name="customization" value={null} className="mt-1 input input-bordered w-full select">
                        <option defaultValue={loadedCraft.customization}>{loadedCraft.customization}</option>
                ...
                <div>
                    ...
                    <input type="text" defaultValue={loadedCraft.processingTime} id="processing_time" name="processing_time" placeholder="Time" className={`input input-bordered w-full mt-2 ${formErrors.processingTime ? 'input-error' : ''}`} />
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <select id="stock_status" name="stock_status" value={null} className="mt-1 input input-bordered w-full select">
                        <option defaultValue={loadedCraft.stockStatus}>{loadedCraft.stockStatus}</option>
