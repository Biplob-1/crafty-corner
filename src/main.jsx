    ...
    children: [
      {
        path:'/',
        element:<Home></Home>,
        loader: () => fetch('https://artful-glass-and-paper-server-p5cjqubef.vercel.app/addCrafts')
      },
      {
        path:'/login',
        element:<Login></Login>,
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://artful-glass-and-paper-server-p5cjqubef.vercel.app/addCrafts/${params.id}`)
      },
      {
